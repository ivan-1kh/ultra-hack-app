...
const lectureQuestionData = [
  {
    questionBody:
      "אם יש לנו נפח גוף 200 סמ״ק והצפיפות 7.8 גרם/סמ״ק מה היא המסה של הגוף?",
    correctAnswer: 1,
    1: "1560 גרם",
    2: "2000 גרם",
    3: "1500 גרם",
...
export default (props) => {
  ...
  React.useEffect(() => {
    setInterval(() => {
      ...
      lectureQuestionData.forEach((element) => {
        if (
          element.endAt === parseInt(video.currentTime) &&
          !element.completed
        ) {
          video.pause();
  ...
  const firstAnswer = (e) => {
    if (currentQuestion.correctAnswer === 1) {
      ...
      document.querySelector("#mainVideo").currentTime =
            ...
            <div className="row">
              <div className="col-lg-8 col-xs-12 col-sm-12">
                ...
                >
                  ...
                  <a className="answerButton" onClick={firstAnswer}>
                    {currentQuestion ? currentQuestion[1] : ""}
                  </a>
                  <a className="answerButton" onClick={secondAnswer}>
                    {currentQuestion ? currentQuestion[2] : ""}
                  </a>
                  <a className="answerButton" onClick={thirdAnswer}>
                    {currentQuestion ? currentQuestion[3] : ""}
                  </a>
                  <a className="answerButton" onClick={fourthAnswer}>
                ...
                <div className="info">
                  ...
                  <p>
                    ...
                    <br />
                    Ultra Hack 2020 Ultra Hack 2020 Ultra Hack 2020 Ultra Hack
                    2020
                  </p>
